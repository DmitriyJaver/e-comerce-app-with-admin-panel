                        ...
                        <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="country_id" id="country_id">
                                @foreach($countries as $id => $country)
                                    <option value="{{ $id }}" {{ ($product->country ? $product->country->id : old('country_id')) == $id ? 'selected' : '' }}>{{ $country }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('color') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="color_id" id="color_id">
                                @foreach($colors as $id => $color)
                                    <option value="{{ $id }}" {{ ($product->color ? $product->color->id : old('color_id')) == $id ? 'selected' : '' }}>{{ $color }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('brand_name') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="brand_name_id" id="brand_name_id">
                                @foreach($brand_names as $id => $brand_name)
                                    <option value="{{ $id }}" {{ ($product->brand_name ? $product->brand_name->id : old('brand_name_id')) == $id ? 'selected' : '' }}>{{ $brand_name }}</option>
                                @endforeach
                            </select>
